...
const project = [
  ...
  {
    name: "Arthro 3D",
    description: "Arthro3D provides 3D visualization tools for orthopedic surgical planning. Their technology creates detailed, customizable models to assist surgeons in improving precision and outcomes in orthopedic procedures.",
    skills: ["React JS", "HTML", "CSS", "Bootstrap", "NPM"],
  ...
  {
    name: "Chiku Orchard",
    description: "Discover Chiku Orchard, where timeless beauty meets modern elegance. With 19 years of wedding event management experience, our 100,000 sq. ft. property boasts a stunning landscape of majestic Chiku trees. Enjoy a magical ambiance and immerse yourself in nature.",
    skills: ["React JS", "HTML", "CSS", "Bootstrap", "NPM"],
  ...
  return (
    <div className="main">
      <div className="col-11 m-auto row align-items-center justify-content-between">
        <div className="col-md-6">
          <div className="py-4">
            ...
            <div className="d-flex gap-4 mt-3 align-items-center" data-aos="fade-up">
              ...
              <button className="btn-light" onClick={()=> window.open('https://drive.google.com/drive/folders/1v4ovUXHIFI43obv0XsFdWAZ6Zv2_ovVG', '_blank')}>View Resume</button>
            </div>
          </div>
        </div>
        <div className="col-md-6">
      ...
      <div className="col-lg-6 col-md-8 col-11 m-auto mt-5 text-center">
        ...
        <button className="btn-light mt-4 " data-aos="fade-up" onClick={()=> router.push('/about')}>
          Know More
        </button>
      </div>
      ...
      <div className="text-center">
          ...
          {project.map((item, index) => (
            <div className="col-lg-4 col-md-6 col-12 mt-5" key={index}>
              <div
                ...
                data-aos="zoom-in"
              >
                <img src={item.image} className="projectImg" alt={`Project ${index + 1}`} />
                <div>
                  <p className="fs-3 fw-bold pink-red">{item.name}</p>
                  <p className="fs-7 tjustify"  >{item.description}</p>
                  <div className=" d-flex gap-3 align-items-center py-3 mb-5 flex-wrap">
                    {item.skills.map((skill, skillIndex) => (
                      <span className="skillsTag" key={skillIndex}>{skill}</span>
                    ))}
                  </div>
                  <div style={{ position: 'absolute', bottom: '20px', left: '0' }} className="col-12 d-flex justify-content-center">
                    <button className="btn-light " onClick={() => window.open(item.link, '_blank')}>Live Demo</button>
        ...
        <button className="btn-light  my-4 m-auto " onClick={()=> router.push('/projects')}>
          View All Projects
        </button>
