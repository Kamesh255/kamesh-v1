...
export const skillsData = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Responsive Design", icon: <MdDevices color="#3da9fc" size={36} /> },
        ...
        <div style={{ overflow: 'hidden' }}>
            <div className="col-11 m-auto row align-items-center gap-md-0 gap-5 my-4">
                <div className="col-md-6">
                    <p className="fs-1 fw-bold" data-aos="fade-up">About Me</p>
            ...
            <div className="col-11 mt-5 m-auto" >
                <p className="fs-1 fw-semibold" data-aos="fade-up">Professional Summary</p>
            ...
            <div className="col-11 mt-5 m-auto">
                <p className="fs-1 fw-semibold" data-aos="fade-up">What I Do</p>
                <ul>
                    <li className="fs-5 mt-3 tjustify" data-aos="fade-up">Build scalable frontend architectures using React and Next.js</li>
                    <li className="fs-5 mt-3 tjustify" data-aos="fade-up">Develop responsive and cross-device compatible UI</li>
                    <li className="fs-5 mt-3 tjustify" data-aos="fade-up">Integrate REST APIs and handle dynamic data efficiently</li>
                    <li className="fs-5 mt-3 tjustify" data-aos="fade-up">Optimize performance and improve loading speed</li>
                    <li className="fs-5 mt-3 tjustify" data-aos="fade-up">Create reusable and maintainable components</li>
                </ul>
            </div>

            <div className="col-11 mt-5 m-auto">
                <p className="fs-1 fw-semibold text-center" data-aos="fade-up">Skills & Technologies</p>
                {skillsData.map((category, i) => (
                    <div key={i}>
                        <p className="fs-1 text-center mt-4" data-aos="fade-up">{category.title}</p>
            ...
            <div>
                <p className="fs-1 fw-bold text-center mt-5" data-aos="fade-up">Education</p>
                        ...
                        <div className="col-lg-4 col-md-6 col-12 mt-5" key={index}>
                            ...
                            >
                                <div className="text-start p-3">
                                    <p className="fs-3 fw-bold pink-red">{item.title}</p>
