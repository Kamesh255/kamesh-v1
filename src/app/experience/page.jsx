...
export const experienceData = [
    {
        ...
        tools: ["VS Code", "GitHub", "GitHub Desktop", "Azure DevOps", "Postman", "Figma", "ChatGPT", "Copilot"]
    },
    {
        ...
        tech: ["React.js", "Next.js", "HTML", "CSS", "JavaScript", "Rest API", "Bootstrap"],
    ...
    },
    {
        ...
        impact: [
            "Delivered clean and responsive UI",
        ],
...
const page = () => {
    return (
        <div>
            ...
            <p className='fs-5 tjutify col-md-8 col-11 m-auto'>A summary of my professional journey and contributions as a frontend developer.</p>

            <div className='mb-5'>
                {
                    experienceData.map((item, index) => (
                        <div key={index} className='darkcard p-3 py-4 col-11 m-auto row gap-md-0 gap-4 mt-5 align-items-center'>
                            <div className='col-md-4 col-12'>
                                <p className='fs-4 fw-bold'>{item.role}</p>
                                <p className='fs-5 fw-bold pink-red'>{item.company}</p>
                                <p className='fs-6 fw-semibold pink-red'>{item.others}</p>
                            ...
                            <div className='col-md-8 col-12'>
                                ...
                                <div className="mt-3 d-flex flex-wrap gap-2">
                                    ...
                                    {item.tech.map((t, i) => (
                                        <span key={i} className="skillsTag">{t}</span>
                                    ))}
                                </div>
